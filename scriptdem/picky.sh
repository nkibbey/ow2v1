...
shuf -n 410874 ${cdir}y1975to1984.txt > ${ncorpus}
...
nmodel=../models/sm_${root}
grepped=../models/g${root}
shuf -n 410874 ${cdir}y1985to1990.txt > ${ncorpus}
...
nmodel=../models/sm_${root}
grepped=../models/g${root}
shuf -n 410874 ${cdir}y1991to1995.txt > ${ncorpus}
...
nmodel=../models/sm_${root}
grepped=../models/g${root}
shuf -n 410874 ${cdir}y1996to1999.txt > ${ncorpus}
...
nmodel=../models/sm_${root}
grepped=../models/g${root}
shuf -n 410874 ${cdir}y2000to2003.txt > ${ncorpus}
...
nmodel=../models/sm_${root}
grepped=../models/g${root}
shuf -n 410874 ${cdir}y2004to2006.txt > ${ncorpus}
...
nmodel=../models/sm_${root}
grepped=../models/g${root}
shuf -n 410874 ${cdir}y2007to2008.txt > ${ncorpus}
...
nmodel=../models/sm_${root}
grepped=../models/g${root}
shuf -n 410874 ${cdir}y2009to2010.txt > ${ncorpus}
...
nmodel=../models/sm_${root}
grepped=../models/g${root}
shuf -n 410874 ${cdir}y2011to2012.txt > ${ncorpus}
...
nmodel=../models/sm_${root}
grepped=../models/g${root}
shuf -n 410874 ${cdir}y2013to2014.txt > ${ncorpus}
